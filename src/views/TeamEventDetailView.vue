...
.ed-boxscore-layout,.ed-player-grid{display:grid;grid-template-columns:minmax(0,1.75fr) minmax(310px,.95fr);gap:16px}.ed-panel{min-width:0}.ed-panel-toolbar{display:flex;align-items:center;justify-content:space-between;padding:16px;border-bottom:1px solid var(--ed-border)}.ed-segments{display:flex;gap:8px}.ed-segments button,.ed-rsvp button{border:1px solid var(--ed-border);background:#0b1727;color:var(--ed-text);padding:8px 22px;border-radius:7px;cursor:pointer}.ed-segments button.is-active,.ed-rsvp button.is-active{border-color:#187dff;background:#187dff;box-shadow:0 0 12px rgba(24,125,255,.26)}.ed-count{color:var(--ed-muted);font-size:13px}
